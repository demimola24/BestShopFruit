...
namespace BestShopFruit.Services
{
    ...
    public class BaseService
    {
        ...
        public BaseService()
        {
            ...
            {
                BaseAddress = new Uri("https://fruitappwp.azurewebsites.net/"),
            };
        }
        ...
        protected async Task<T> GetAsync<T>(string endpoint)
        {
            ...
            catch (Exception ex)
            {
                ...
                await Shell.Current.DisplayAlert("Error!", ex.Message, "error");
                return default;
            }
        }
        ...
        private bool IsInternetAvailable()
        {
            ...
            if (accessType != NetworkAccess.Internet)
            {
                if (Shell.Current != null)
                {
                    ...
                    {
                        Shell.Current.DisplayAlert("Error!", "Internet is limited.", "error");
                    }
                    else
                    {
                        Shell.Current.DisplayAlert("Error!",  "Internet is not available.", "error");
                    }
                }
